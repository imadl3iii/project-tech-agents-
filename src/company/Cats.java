...
public final class Cats {
    ...
    static {
        ...
        try {
            // Load labels
            BufferedReader reader = new BufferedReader(new FileReader(".\\src\\company\\categories.txt"));
            String line;
            int count = 0;
    ...
    public static void createCategory(String categoryName, ArrayList<String> variablesList, ArrayList<String> inputVariables) {
        ...
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter(".\\src\\company\\categories.txt", true));
        ...
        try {
            File labelsFile = new File(".\\src\\company\\" + categoryName + "Labels.txt");
            if (labelsFile.createNewFile()) {
                System.out.println("File created: " + labelsFile.getName());
            } else {
                System.out.println("File already exists.");
            }
            BufferedWriter writer = new BufferedWriter(new FileWriter(".\\src\\company\\" + categoryName + "Labels.txt", true));
        ...
        try {
            File rulesFile = new File(".\\src\\company\\" + categoryName + "Rules.txt");
