...
public final class PizzaMain {
    ...
    static {
        ...
        try {
            ...
            BufferedReader reader = new BufferedReader(new FileReader(filePath + ".\\src\\company\\pizzaLabels.txt"));
            String line;
    ...
    public static void readOneRule() throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader(".\\src\\company\\pizzaRules.txt"));
